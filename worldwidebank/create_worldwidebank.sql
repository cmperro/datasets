...
DROP TABLE IF EXISTS worldwidebank.us_customers_temp;

CREATE TEMPORARY EXTERNAL TABLE worldwidebank.us_customers_temp(
 number string,
 gender string,
 title string,
 givenname string,
...
CREATE TABLE worldwidebank.us_customers(
  number string,
  gender string,
  title string,
  givenname string,
...
DROP TABLE worldwidebank.us_customers_temp;
------


DROP TABLE IF EXISTS worldwidebank.ww_customers_temp;

CREATE EXTERNAL TABLE worldwidebank.ww_customers_temp(
  gender string,
  title string,
  givenname string,
  middleinitial string,
...
-- ALTER TABLE worldwidebank.ww_customers_temp SET SERDEPROPERTIES ('serialization.encoding'='SJIS');

-- INSERT OVERWRITE LOCAL DIRECTORY '/home/hive/ww_customers' 
-- ROW FORMAT DELIMITED 
-- FIELDS TERMINATED BY ',' 
-- select * from worldwidebank.ww_customers;
-- */

DROP TABLE IF EXISTS worldwidebank.ww_customers;

CREATE TABLE worldwidebank.ww_customers(
  gender string,
  title string,
  givenname string,
  middleinitial string,
...
gender
  ...
  ,latitude
  ,longitude
FROM worldwidebank.ww_customers_temp;

DROP TABLE worldwidebank.ww_customers_temp;

-----

DROP TABLE IF EXISTS worldwidebank.eu_countries_temp;

CREATE TEMPORARY EXTERNAL TABLE worldwidebank.eu_countries_temp(
  countryname string,
  countrycode string,
  region string)
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
...
CREATE TABLE worldwidebank.eu_countries(
  countryname string,
  countrycode string,
  region string)
STORED AS ORC
...
DROP TABLE worldwidebank.eu_countries_temp;
